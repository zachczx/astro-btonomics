...
pubDate: 2018-04-08
description: 'Budget guide for shopping and shipping from Taobao to Singapore. Details a 5-step shopping process and compares 6 shipping options including direct, consolidated, and third-party services.'
category: 'Shopping'
author: 'ZC'
image: './Taobao-SS.jpg'
...
![It's no wonder Taobao scares people, the website user interface is incredibly messy.](./Taobao-SS.jpg) _It's no wonder Taobao scares people, the website user interface is incredibly messy._
...
3. Sort by the amount of sales (select 销量 instead of 综合排序) - the default view 综合排序 almost never gives the best option in terms of prices, quality, and popularity. ![Screenshot](./search_.jpg)_Screenshot_
...
1. At this point, you should download [阿里旺旺](https://alimarket.taobao.com/markets/qnww/portal-group/ww/download) and talk to the seller. You usually click on a blue bubble beside the seller's name to activate 阿里旺旺, or a popup will emerge to ask you to either download the software or use the web interface. (Protip: the web interface sucks.) ![Screenshot](./aliwangwang.jpg) _Screenshot_
...
3. Go to the product page for the item you want. Click the button that pops up: ![Screenshot](./Screenshot-2019-07-14-21.43.55.jpg)_Screenshot_
4. If there's no cashback there's a pop up on the right that says this item doesn't have cashback.
5. Click the button and you'll see this: ![Screenshot](./Screenshot-2019-07-14-21.48.37.jpg) _Screenshot_
6. Add the item to the cart.
7. When you check your cart this should show: ![Screenshot](./Screenshot-2019-07-14-21.50.26.png)_Screenshot_
...
![](./8TzEMmn6PuV9Xs3JZm.gif)

### **Step 5: It's time to pay and buy your stuff**

1. Go to the shopping cart and check out whether there're any coupons for your items. You can collect coupons under the 优惠券 drop-down menu. ![](./cart.jpg)
2. Make sure those with Shopback discounts show up like that: ![Screenshot](./Screenshot-2019-07-14-21.50.26.png)_Screenshot_
...
6. Select your desired shipper. 直送 means Taobao global direct shipping and 集运 refers to consolidated shipping via third-party shipping. We explain these options further below. To select something else just select 修改服务商. ![Screenshot](./shipping.jpg) _Screenshot_
7. Check your China domestic postage fee (运送方式) and whether it's free. ![Screenshot](./confirmation.jpg)_Confirmation_
...
![Screen with shipping options after checking out your cart.](./shipping-options.jpg) _Screen with shipping options after checking out your cart._
...
![Don't doubt the efficiency of Taobao.](./funny-ups-shipping-one-day1.jpg) _Don't doubt the efficiency of Taobao._
...
![That's probably why your sea shipments take an eternity to reach.](./pirates-stealing-container-boat-shipping-13764769137.jpg) _That's probably why your sea shipments take an eternity to reach._
...
![](./phew.gif) _Phew that was a long one._
...
1. You change your delivery address to the China warehouse address that Sfinex gives you in the members' area. ![Screenshot](./members-area-sfinex.png) _Screenshot_
...
5. When everything is 签收 (signed for by the warehouse) in the system, you should fill in the details of your parcels through Sfinex's web interface (courier company, delivery tracking no, brief description, number of boxes, and value of item). ![Screenshot](./insert-orders.png) _Screenshot_
6. There're many types of shipping options. Select the desired one. If in doubt, select 新加坡免抛.
7. Once submitted, SFinex's system will calculate the shipping weight and fee. ![Screenshot](./weighing.png) _Screenshot_
8. For SFinex, you can't pay via normal means because we don't have a China-issued credit card. So you pay via Taobao. SFinex will send you a link to a 1 yuan dummy item on Taobao, you'd just buy the quantities needed to pay for your shipping. E.g. if your fee is RMB 120, just buy 120 of this RMB 1 item. ![](./taobao-sfinex-item.jpg) _Screenshot_
9. The next step is to submit a form (similar to Ezbuy) to say how much you paid, when you paid, and upload a screenshot of the payment. They'll verify it. What happens is you loaded your account with money, which can be used for payment. ![Screenshot](./top-up.png) _Screenshot_
10. The final step is to go to the air shipment orders page and click "[付款]". This uses the money you loaded to pay for the shipment. (Ignore the part where it says 待付款, re-used the same screenshot) ![Screenshot](./weighing.png) _Screenshot_
